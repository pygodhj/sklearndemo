...
from src.database_models.database_operate import DatabaseOperate
#
#
...
tablename="students"
columns="name TEXT NOT NULL,age INTEGER,major TEXT"
DatabaseOperate.create_table(tablename,columns)